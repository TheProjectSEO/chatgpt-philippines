...
export default function OutlineGeneratorPage() {
  ...
  const handleCopy = async () => {
    ...
    try {
      await navigator.clipboard.writeText(generatedOutline);
      setCopied(true);
  ...
  // Load sample
  const loadSample = () => {
    setTopic('Digital Marketing Strategies for Small Businesses');
    setRequirements('Include sections on social media, SEO, email marketing, and content marketing. Target audience is Filipino small business owners with limited budgets.');
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-purple-50 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="flex items-center gap-2 text-sm text-neutral-600 mb-6">
            ...
            <span className="text-neutral-800 font-medium">Outline Generator</span>
          </div>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-neutral-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Generate comprehensive outlines for essays, articles, and reports instantly.
              Organize your thoughts and save hours of planning time.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-600">Outlines</div>
              </div>
              <div className="text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-neutral-200">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm text-neutral-600 mb-2 block">Requirements & Specifications (optional)</label>
                    <textarea
                      value={requirements}
                      onChange={(e) => setRequirements(e.target.value)}
                      placeholder="Specify sections to include, target audience, word count, special requirements..."
                  ...
                  {isGenerating ? (
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center">
                        ...
                        <p className="text-neutral-600">Generating outline...</p>
                      </div>
                    </div>
                  ) : generatedOutline ? (
                    ...
                    <p className="text-neutral-400">Your outline will appear here...</p>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Create structured, comprehensive outlines that make writing easier
            </p>
          </div>
            ...
            {[
              {
                icon: Sparkles,
                title: 'AI-Powered',
                description: 'Advanced AI creates logical, well-structured outlines',
              ...
              },
              {
                ...
                description: 'Generate comprehensive outlines in seconds',
              ...
              },
              {
                ...
                description: 'Hierarchical outlines with clear sections and subsections',
                color: 'text-blue-600',
                bg: 'bg-blue-50',
              },
              {
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-50 to-purple-50">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              Perfect For Every Writing Project
            </h2>
            ...
            {[
              {
                ...
                description: 'Plan essays, research papers, and dissertations with structured outlines. Organize complex topics and ensure comprehensive coverage of all key points.',
                stats: 'All levels',
              },
              {
                icon: BookOpen,
                title: 'Content Writers',
                description: 'Structure blog posts, articles, and guides with clear outlines. Plan your content flow and ensure logical progression of ideas.',
                stats: 'All topics',
              },
              {
                icon: Briefcase,
                title: 'Business Professionals',
                description: 'Organize reports, proposals, and business plans. Create comprehensive structures that cover all necessary sections and details.',
                stats: 'All industries',
              },
              {
                icon: Users,
                title: 'Project Managers',
                description: 'Plan presentations, project documentation, and strategic documents. Ensure nothing is overlooked with detailed outlines.',
                stats: 'All projects',
              },
            ].map((useCase, idx) => (
              <div
      ...
      <section className="py-16 md:py-24 bg-neutral-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Everything you need to know about our outline generator
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: 'Our AI analyzes your topic and requirements to create a logical, hierarchical outline with main sections, subsections, and key points that provide a complete structure for your content.',
              },
              {
                question: 'Can I customize the outline structure?',
                answer: 'Yes! In the requirements field, specify how many sections you need, what topics to cover, the depth of detail, or any specific structure you prefer.',
              },
              {
                question: 'What types of outlines can it generate?',
                answer: 'The generator creates outlines for essays, research papers, articles, reports, business plans, presentations, and more. It adapts to your specific content type.',
              },
              {
                question: 'How detailed are the outlines?',
                answer: 'Outlines include main sections, subsections, and key points. The level of detail adapts based on your topic complexity and any requirements you specify.',
              },
              {
                question: 'Is it really free?',
                answer: 'Yes! The outline generator is completely free. Guest users get 10 free generations, then you can create a free account for unlimited access.',
              },
            ].map((faq, idx) => (
              <details
                key={idx}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-500 to-purple-600 text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Start Generating Outlines Now
          </h2>
          <p className="text-lg md:text-xl text-orange-50 mb-8 max-w-2xl mx-auto">
            Join thousands of writers organizing their ideas with AI
          </p>
          <button
