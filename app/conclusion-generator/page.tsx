...
export default function ConclusionGeneratorPage() {
  ...
  const handleGenerate = async () => {
    if (!topic.trim() || !keyPoints.trim()) {
      alert('Please enter both topic and key points');
      return;
    }
    ...
    try {
      const response = await fetch('/api/conclusion-generate', {
        method: 'POST',
        headers: {
      ...
      alert(error.message || 'Failed to generate conclusion. Please try again.');
    } finally {
  ...
  const handleCopy = async () => {
    if (!generatedConclusion) return;

    try {
      await navigator.clipboard.writeText(generatedConclusion);
      setCopied(true);
  ...
  // Load sample
  const loadSample = () => {
    setTopic('The Impact of Artificial Intelligence on Modern Education');
    setKeyPoints('AI personalizes learning, automates administrative tasks, provides instant feedback, makes education more accessible, and prepares students for future careers in technology');
  };
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-purple-50 pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="flex items-center gap-2 text-sm text-neutral-600 mb-6">
            ...
            <span className="text-neutral-800 font-medium">Conclusion Generator</span>
          </div>

          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
              <FileCheck size={18} />
              <span>AI-Powered Conclusions</span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 mb-6 leading-tight">
              Conclusion Generator - End Strong{' '}
            ...
            <p className="text-lg md:text-xl text-neutral-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Generate compelling conclusions for essays, articles, and reports instantly.
              Perfect for students, writers, and professionals.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-8">
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-600">Conclusions</div>
              </div>
              <div className="text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-neutral-200">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm text-neutral-600 mb-2 block">Main Points (comma-separated or line-by-line)</label>
                    <textarea
                      value={keyPoints}
                      onChange={(e) => setKeyPoints(e.target.value)}
                      placeholder="Enter the key points you want to summarize in the conclusion..."
                  ...
                  {isGenerating ? (
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center">
                        ...
                        <p className="text-neutral-600">Generating conclusion...</p>
                      </div>
                    </div>
                  ) : generatedConclusion ? (
                    ...
                    <p className="text-neutral-400">Your conclusion will appear here...</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-neutral-200 p-6 bg-neutral-50">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button
                  ...
                  disabled={isGenerating || !topic.trim() || !keyPoints.trim()}
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Create powerful, memorable conclusions that leave a lasting impact
            </p>
          </div>
            ...
            {[
              {
                icon: Sparkles,
                title: 'AI-Powered',
                description: 'Advanced AI creates engaging, context-aware conclusions',
              ...
              },
              {
                ...
                description: 'Generate professional conclusions in seconds',
              ...
              },
              {
                ...
                description: 'Well-organized conclusions that summarize key points',
                color: 'text-blue-600',
                bg: 'bg-blue-50',
              },
              {
            ...
            {[
              {
                ...
                description: 'Create strong conclusions for essays, research papers, and dissertations. Summarize your arguments effectively and leave a lasting impression.',
                stats: 'All levels',
              },
              {
                icon: Briefcase,
                title: 'Business Professionals',
                description: 'End your reports, proposals, and presentations with impact. Summarize findings and recommendations clearly and professionally.',
                stats: 'All industries',
              },
              {
                icon: BookOpen,
                title: 'Content Writers',
                description: 'Craft compelling endings for blog posts, articles, and white papers. Drive home your message and inspire action.',
                stats: 'All topics',
              },
              {
                icon: Users,
                title: 'Marketing Teams',
                description: 'Close sales pages, case studies, and marketing materials with powerful CTAs. Convince readers to take the next step.',
      ...
      <section className="py-16 md:py-24 bg-neutral-50">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600">
              Everything you need to know about our conclusion generator
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                question: 'How does the AI conclusion generator work?',
                answer: 'Our AI analyzes your topic and key points to create a cohesive, well-structured conclusion that summarizes your main arguments and provides a strong ending to your content.',
              },
              {
                question: 'Can I use this for academic papers?',
                answer: 'Yes! Our generator is perfect for academic writing including essays, research papers, and dissertations. It creates professional conclusions that meet academic standards.',
              },
              {
                question: 'What should I include in key points?',
                answer: 'Include the main arguments or findings from your content. List them as bullet points or separate them with commas. The AI will weave them into a coherent conclusion.',
              },
              {
                question: 'How long are the generated conclusions?',
                answer: 'Conclusions are typically 150-250 words, which is ideal for most content types. The length adapts based on the number of key points you provide.',
              },
              {
                question: 'Is it really free?',
                answer: 'Yes! The conclusion generator is completely free. Guest users get 10 free generations, then you can create a free account for unlimited access.',
              },
            ].map((faq, idx) => (
              <details
                key={idx}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-500 to-purple-600 text-white">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Start Generating Conclusions Now
          </h2>
          <p className="text-lg md:text-xl text-orange-50 mb-8 max-w-2xl mx-auto">
            Join thousands of writers creating powerful conclusions with AI
          </p>
          <button
